...
public class GroupService(IGroupRepository repo,
    // IValidator<GroupDto> groupValidator,
    Group.GroupBuilder groupBuilder) : IGroupService
{
    private readonly IGroupRepository _repo = repo;
    // private readonly IValidator<GroupDto> _groupValidator = groupValidator;
    private readonly Group.GroupBuilder _groupBuilder = groupBuilder;
